package nl.knaw.dans.repo.arrdf.xml;
...
public enum Capability {
    ...
    /**
     * A Capability List is a document that enumerates all capabilities supported by a Source for a specific set of
     * resources.
     */
    CAPABILITYLIST("capabilitylist", 2),

    /**
     * A Resource List is introduced to list and describe the resources that a Source makes available for
     * synchronization.
     */
