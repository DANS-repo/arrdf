...
public class FileCleanerTest {
    ...
    public void testCleaner() throws Exception {
        ...
        fileSet.add(new File(
          "/Users/ecco/git/rs-aggregator/target/test-output/synchronizer/zandbak11.dans.knaw" +
            ".nl/ehri2/mdx/__SOR__/ehri2/tmp/rs/collection2/folder1/doc1.txt"));
        fileSet.add(new File(
          "/Users/ecco/git/rs-aggregator/target/test-output/synchronizer/zandbak11.dans.knaw" +
            ".nl/ehri2/mdx/__SOR__/ehri2/tmp/rs/collection2/folder1/doc2.txt"));
