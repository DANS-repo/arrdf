    ...
    public void testNormalize() throws Exception {
        String[][] expectations = {
          {"http://www.ZANdbak02.dans.KNAW.nl/ehri2/..///mdy//capabilitylist.xml",
            "http://zandbak02.dans.knaw.nl/mdy/capabilitylist.xml"},
          {"http://www.ZANdbak02.dans.KNAW.nl/ehri2/..///mdy//capabilitylist.xml#abc",
            "http://zandbak02.dans.knaw.nl/mdy/capabilitylist.xml"},
          ...
          {null, null},
          {"", ""},
          {"http://Publisher-Connector.CORE.ac" +
            ".uk/resourcesync/data/elsevier/pdf/000" +
            "/aHR0cDovL2FwaS5lbHNldmllci5jb20vY29udGVudC9hcnRpY2xlL3BpaS8wMDE0NTc5MzkwODA1MTdt.pdf",
            "http://publisher-connector.core.ac" +
              ".uk/resourcesync/data/elsevier/pdf/000" +
              "/aHR0cDovL2FwaS5lbHNldmllci5jb20vY29udGVudC9hcnRpY2xlL3BpaS8wMDE0NTc5MzkwODA1MTdt.pdf"},
        ...
        for (String[] expectation : expectations) {
            ...
            if (maybeURI.isPresent()) {
                normalized = maybeURI.get().toString();
            }
